...
<input type="hidden" name="apffw_settings[<?php _e($key);?>][search_logic]" value="<?php _e((isset($settings[$key]['search_logic']) ? $settings[$key]['search_logic'] : "OR"));?>" /> 
<div id="apffw-modal-content-<?php _e($key);?>" style="display: none;">
    ...
    <div class="apffw-form-element-container">
        <div class="apffw-name-description">
            <strong><?php esc_html_e('Search logic', 'apffw-products-filter') ?></strong>
            <span><?php esc_html_e('Check search logic AND/OR', 'apffw-products-filter') ?></span>
        </div>

        <div class="apffw-form-element">
            <?php
            $logic = array(
                'OR' => esc_html__('OR', 'apffw-products-filter'),
                'AND' => esc_html__('AND', 'apffw-products-filter')
            );
            ?>

            <div class="select-wrap">
                <select class="apffw_popup_option" data-option="search_logic">
