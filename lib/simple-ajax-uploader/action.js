...
function apffw_init_ext_uploader(abspath, location, url) {
    ...
    var uploader = new ss.SimpleUpload({
        ...
        onSubmit: function (filename, ext) {
            apffw_show_info_popup('Extension file uploading ...');
        ...
        onComplete: function (file, response, btn) {
            apffw_show_info_popup('Extension is uploaded!');
            if (typeof response.ext_info.title != 'undefined') {
                var tpl = jQuery('#apffw_ext_tpl').html();
                tpl = tpl.replace(/__NAME__/g, "apffw_settings[activated_extensions][]");
                ...
                jQuery('ul.apffw_custom_extensions').append(tpl);
            } else {
